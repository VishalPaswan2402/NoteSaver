        ...
        <>
            <div id='note-container' className={` align-middle text-center`}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} id='input-container' className='grid max-w-2xl m-auto gap-4 mt-2'>
                    ...
                    <button type='submit' className={`font-para border-2 rounded-sm p-1 mb-1 cursor-pointer transition-all duration-200 voiletButton btnColor text-[#EBE8DB] hover:border-[#3D0301] border-[#B03052]`}>Update Clone</button>
                </form>
            </div>
        </>
    )
