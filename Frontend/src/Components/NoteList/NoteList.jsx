            ...
            <div className='bg-blue-100 border-1 flex min-w-2xl m-auto mt-3 p-2 hover:bg-blue-200 rounded-lg'>
                <div className='flex w-full  cursor-pointer'>
                    <div className=' w-7/1 p-1'>
                        <p className='font-semibold text-rose-800'>{props.name.length > 20 ? props.name.slice(0, 20) + "..." : props.name}</p>
                        {
                            props.description.length > 50
                                ?
                                <>
                                    <p className='text-gray-600'>{props.description.slice(0, 55)}...</p>
                                    <p className='text-gray-600'>...{props.description.slice(props.description.length - 50, props.length)}</p>
                                </>
                                :
                    ...
                    <div className='w-3/1 justify-center place-content-evenly '>
                        <Link to={`/v1/view-note/id`}><button className='w-10 cursor-pointer border-2 border-gray-400 rounded-lg p-2 m-1 text-gray-600 hover:text-black hover:border-black hover:bg-white'><i className="fa-solid fa-eye"></i></button></Link>
