        ...
        <>
            <div id='note-container' className='align-middle text-center'>
                ...
                <div id='input-container' className='grid max-w-2xl m-auto gap-4 mt-2'>
                    <input type='text' placeholder='Enter title' className='outline-2 focus:outline-blue-700 p-2 rounded-lg' defaultValue={props.title} disabled={!props.edit}></input>
                    <textarea id='note-area' type='text' placeholder='Enter description' className={`outline-2 focus:outline-blue-700 p-2 rounded-lg h-101 resize-none overflow-y-auto`} defaultValue={props.disc} disabled={!props.edit}></textarea>
                    {
                        props.edit
                            ?
                            (
